...
trainData = trainData.reshape((trainData.shape[0], TARGET_IMAGE_WIDTH, TARGET_IMAGE_HEIGHT, 3))
testData = testData.reshape((testData.shape[0], TARGET_IMAGE_WIDTH, TARGET_IMAGE_HEIGHT, 3))
...
opt = Adam(lr=LR)
# opt = RMSprop(lr=LR)
model = CNNNet.build(TARGET_IMAGE_WIDTH, TARGET_IMAGE_HEIGHT, NUM_CLASSES, '', 3)
